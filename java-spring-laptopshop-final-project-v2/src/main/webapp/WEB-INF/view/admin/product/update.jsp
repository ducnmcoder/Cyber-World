            ...
            <head>
                ...
                <script>
                    $(document).ready(() => {
                        ...
                        const urlImage = "${newProduct.firstImage}";
                        if (urlImage && urlImage !== "/images/product/default.png") {
                                                        ...
                                                        <div class="mb-3 col-12 col-md-6">
                                                            ...
                                                            <div class="dropdown w-100">
                                                                ...
                                                                <ul class="dropdown-menu w-100" aria-labelledby="targetDropdown">
                                                                    ...
                                                                    <li class="dropdown-item px-2 py-1"><div class="form-check"><input class="form-check-input target-checkbox" type="checkbox" value="SINHVIEN-VANPHONG" id="target_2"><label class="form-check-label w-100" for="target_2">Sinh viên - Văn phòng</label></div></li>
                                                                    <li class="dropdown-item px-2 py-1"><div class="form-check"><input class="form-check-input target-checkbox" type="checkbox" value="THIET-KE-DO-HOA" id="target_3"><label class="form-check-label w-100" for="target_3">Thiết kế đồ họa</label></div></li>
                                                                    <li class="dropdown-item px-2 py-1"><div class="form-check"><input class="form-check-input target-checkbox" type="checkbox" value="MONG-NHE" id="target_4"><label class="form-check-label w-100" for="target_4">Mỏng nhẹ</label></div></li>
                                                                    <li class="dropdown-item px-2 py-1"><div class="form-check"><input class="form-check-input target-checkbox" type="checkbox" value="DOANH-NHAN" id="target_5"><label class="form-check-label w-100" for="target_5">Doanh nhân</label></div></li>
                                                                </ul>
