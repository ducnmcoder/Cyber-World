                                ...
                                <div class="row">
                                    <div class="col-12 mx-auto">
                                        <div class="d-flex justify-content-between">
                                            <h3>Table News</h3>
                                            <a href="/admin/news/create" class="btn btn-primary">Create New News</a>
                                        </div>
                                        <hr />
                                            ...
                                            <tbody>
                                                <c:forEach var="blog" items="${blogs}">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="/admin/news/${blog.id}"
                                                                class="btn btn-success">View</a>
                                                            <a href="/admin/news/update/${blog.id}"
                                                                class="btn btn-warning mx-2">Update</a>
                                                            <a href="/admin/news/delete/${blog.id}"
                                                    ...
                                                    <c:forEach begin="0" end="${totalPages - 1}" varStatus="loop">
                                                        <li class="page-item">
                                                            <a class="${(loop.index + 1) eq currentPage ? 'active page-link' : 'page-link'}"
                                                                href="/admin/news?page=${loop.index + 1}">
                                                                ${loop.index + 1}
                                                            </a>
                                                        </li>
                                                    </c:forEach>
