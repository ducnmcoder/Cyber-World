                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card mb-4">
                                            ...
                                            <div class="card-body">
                                                <form:form method="post" action="/account/manage/info"
                                                    ...
                                                    <div class="mb-3">
                                                        <img style="max-height: 250px; ${empty currentUser.avatar ? 'display:none;' : ''}"
                                ...
                                <div id="layoutSidenav_content">
                                    <main>
                                        <div class="container-fluid px-4">
                                            ...
                                            <c:if test="${param.success == 'info'}">
                                                <div class="alert alert-success">Personal information updated
                                                    successfully.</div>
                                            </c:if>
                                            <c:if test="${param.success == 'password'}">
                                                <div class="alert alert-success">Password updated successfully.</div>
                                            ...
                                            <c:if test="${param.error == 'password_mismatch'}">
                                                <div class="alert alert-danger">Passwords do not match. Please try
                                                    again.</div>
                                            </c:if>
                                            <c:if test="${param.error == 'email_exists'}">
                                                <div class="alert alert-danger">Email already exists. Please choose
                                                    another one.</div>
                                            </c:if>
                                            <div class="row">
                                                <div class="col-md-6">
